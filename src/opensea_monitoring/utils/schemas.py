...
def get_opensea_payload_raw_schema() -> T.StructType:
    return T.StructType(
        [
                        ...
                        T.StructField(
                            ...
                            T.StructType(
                                [
                                    ...
                                    T.StructField("nft_id", T.StringType(), True),
                                    T.StructField(
                                        "chain",
                                        T.StructType(
                                            [
                        ...
                        T.StructField(
                            ...
                            T.StructType(
                                [
                                    ...
                                    T.StructField("eth_price", T.StringType(), True),
                                    T.StructField("usd_price", T.StringType(), True),
                                ]
                            ),
                        ),
                    ]
